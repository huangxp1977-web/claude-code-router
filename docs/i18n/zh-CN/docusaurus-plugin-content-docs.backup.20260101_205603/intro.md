...
[![npm version](https://badge.fury.io/js/%40musistudio%2Fclaude-code-router.svg)](https://www.npmjs.com/package/@thxp/claude-code-router)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Node Version](https://img.shields.io/node/v/@thxp/claude-code-router.svg)
...
# 或
pnpm add -g @thxp/claude-code-router
# 或
yarn global add @thxp/claude-code-router
```
...
- **CLI** (`@thxp/claude-code-router`): 提供 `ccr` 命令的命令行工具
- **Server** (`@thxp/server`): 处理 API 路由和转换的核心服务器
- **Shared** (`@thxp/shared`): 共享常量和工具
- **UI** (`@thxp/ui`): Web 管理界面（React + Vite）
