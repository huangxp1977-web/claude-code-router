  ...
  ({ className, type, ...props }, ref) => {
    ...
    return (
      <input
        ...
        onBlur={handleBlur}
        className={cn(
          "flex h-10 w-full rounded-md border border-slate-400 hover:border-slate-500 bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-slate-500 focus-visible:ring-2 focus-visible:ring-slate-300 focus-visible:ring-offset-2 transition-all disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
          className
        )}
        ref={ref}
      />
